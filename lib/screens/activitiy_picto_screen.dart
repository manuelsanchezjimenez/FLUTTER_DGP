...
class ActivityPictoScreen extends StatefulWidget{
  String name, link, descripcion;
  final dataImage;
  ActivityPictoScreen({required this.name, required this.link, required this.descripcion, required this.dataImage});
  @override
  _ActivityScreen createState() => _ActivityScreen();
}

class _ActivityScreen extends State<ActivityPictoScreen> {
 // late VideoPlayerController _controller;
  late YoutubePlayerController? _youtubecontroller;
  int selectedIndex = 1;
  int cont = 0;
  List<String> buttons = ["Pasos", "Video"];
  List<String> buttons_picto = ["pictogramas.png", "play.png"];
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child:Image.asset(buttons_picto[index].toString())
                                          )
                                        ],
                                      )
                                  ),
